...
class GameUI {
    // Event playback, controls, card animations and feedback live in
    // ui_events.js / ui_controls.js / ui_renderer.js / ui_feedback.js
    // (loaded after this file). Keep GameUI here as state/bootstrap only.

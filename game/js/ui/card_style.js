...
(function () {
  ...
  const ICON_PATHS = {
    ...
    trophy_IceSealTrophy: cardAssetUrl('icons/buff_icons/ice_seal.webp'),
    trophy_HypothermiaTrophy: cardAssetUrl('icons/buff_icons/hypothermia.webp'),

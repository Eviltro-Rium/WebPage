...
(function (global) {
  ...
  const definitions = [
    { id: 'burn',        property: 'burn',        label: '灼烧', icon: 'buff_icons/burn.png',         polarity: 'debuff', stack: true,  max: 5, cleanse: 'decrement', trigger: 'turnEnd' },
    { id: 'bleed',       property: 'bleed',       label: '流血', icon: 'buff_icons/bleed.png',        polarity: 'debuff', stack: true,  max: 3, cleanse: 'decrement', trigger: 'turnEnd' },
    { id: 'poison',      property: 'poison',      label: '中毒', icon: 'buff_icons/poison.png',       polarity: 'debuff', stack: true,  max: 3, cleanse: 'decrement', trigger: 'turnEnd' },
    { id: 'freeze',      property: 'frozen',      label: '冷冻', icon: 'buff_icons/freeze.png',       polarity: 'debuff', stack: false, max: 1, cleanse: 'reset',     trigger: 'turnEnd' },
    { id: 'blind',       property: 'blind',       label: '致盲', icon: 'buff_icons/blind.png',        polarity: 'debuff', stack: false, max: 1, cleanse: 'reset',     trigger: 'persistent' },
    ...
    { id: 'crit',        property: 'crit',        label: '暴击', icon: 'buff_icons/crit.png',         polarity: 'buff',   stack: true, max: 3, cleanse: 'decrement', trigger: 'onAttack', transferable: true },
    { id: 'lush',        property: 'lush',        label: '茂盛', icon: 'buff_icons/lush.png',         polarity: 'buff',   stack: true, max: 2, cleanse: 'decrement', trigger: 'attackStart', transferable: true },
    { id: 'parasite',    property: 'parasite',    label: '寄生', icon: 'buff_icons/parasite.png',     polarity: 'buff',   stack: true, max: 1, cleanse: 'decrement', trigger: 'attackStart', transferable: true },
    { id: 'diving',      property: 'diving',      label: '潜水', icon: 'buff_icons/diving.png',       polarity: 'buff',   stack: false, max: 1, cleanse: 'reset', trigger: 'onBlueAttack' },
    { id: 'bloodthirst', property: 'bloodthirst', label: '嗜血', icon: 'ui_icons/blood_thirsty.png',   polarity: 'buff',   stack: false, max: 1, cleanse: 'reset', trigger: 'hpThreshold' },
    { id: 'chaos_red',   property: 'chaos_red',   label: '混沌·红', icon: 'buff_icons/chaos_red.png',    polarity: 'buff', stack: false, max: 1, cleanse: 'reset', trigger: 'onColorPlay' },
    { id: 'chaos_yellow',property: 'chaos_yellow',label: '混沌·黄', icon: 'buff_icons/chaos_yellow.png', polarity: 'buff', stack: false, max: 1, cleanse: 'reset', trigger: 'onColorPlay' },
    { id: 'chaos_blue',  property: 'chaos_blue',  label: '混沌·蓝', icon: 'buff_icons/chaos_blue.png',   polarity: 'buff', stack: false, max: 1, cleanse: 'reset', trigger: 'onColorPlay' },
    { id: 'chaos_green', property: 'chaos_green', label: '混沌·绿', icon: 'buff_icons/chaos_green.png',  polarity: 'buff', stack: false, max: 1, cleanse: 'reset', trigger: 'onColorPlay' }
  ];

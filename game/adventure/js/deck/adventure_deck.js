...
(function () {
  ...
  const trophyWhite = (name = 'BurnTrophy') => Object.assign(
    ...
    },
    {
      ...
      trophyWhite: true,
      trophyName: name,
      trophyEffect: ({ BurnTrophy: 'burn', PiercingTrophy: 'bleed', FreezeTrophy: 'freeze', RussianRouletteTrophy: 'roulette', FlyTrophy: 'fly', LushTrophy: 'lush', PoisonTrophy: 'poison', ParasiteTrophy: 'parasite', TimeBombTrophy: 'bomb', GuardTrophy: 'guard', DisarmTrophy: 'disarm', ZeroTrophy: 'zero' })[name] || null,
      chosenColor: null,
      isBlack: false,
      isWhite: true,
      isNumberCard: false,

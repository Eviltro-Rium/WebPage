  ...
  "FrozenOceanSeal": [
    {
      "title": "抽牌展示",
      "lines": [
        "进攻1/2/3时从怪物牌堆抽1张牌展示，造成对应数字的伤害",
        "若抽到数字牌则放入弃牌堆，若抽到魔法牌则加入手牌"
      ]
    }
  ],
  "FrozenPolarBear": [
    {
      "title": "暴击机制",
      "lines": [
        "[暴击]上限2层；伤害>4时才能消耗1层[暴击]使攻击不可防御",
        "进攻4/5/6时获得1层[暴击]",
        "进攻1/2/3时若有[暴击]且伤害>4（即对手buff总层数>4），自动消耗1层使攻击不可防御"
      ]
    },
    {
      "title": "buff总层数",
      "lines": [
        "进攻1/2/3造成对手所有buff（正面+负面）层数之和点伤害",
        "包括：灼烧、冷冻、流血、中毒、致盲、冰封、守护、飞翔、暴击、茂盛、寄生、失温、潜水、嗜血、混沌等"
      ]
    }
  ],
  "FrozenOceanSnowyOwl": [

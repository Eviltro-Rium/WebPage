...
(function () {
  ...
  R.registerItem({
    ...
    icon: '../icons/buff_icons/burn.webp',
    price: 5,
  ...
  R.registerItem({
    ...
    icon: '../icons/buff_icons/bleed.webp',
    useScene: 'combat',
    price: 5,
  ...
  R.registerItem({
    ...
    icon: '../icons/buff_icons/freeze.webp',
    useScene: 'combat',
    price: 5,
  ...
  R.registerItem({
    ...
    icon: '../icons/card_icons/Russian_roulette.webp',
    useScene: 'combat',
    price: 5,
  ...
  R.registerItem({
    ...
    icon: '../icons/buff_icons/fly.webp',
    useScene: 'combat',
    price: 5,
    combatUse: 'trophyFly',
    trophyEffect: 'fly',
  ...
  R.registerItem({
    ...
    icon: '../icons/buff_icons/lush.webp',
    useScene: 'combat',
    price: 5,
  ...
  R.registerItem({
    ...
    icon: '../icons/buff_icons/poison.webp',
    useScene: 'combat',
    price: 5,
  ...
  R.registerItem({
    ...
    icon: '../icons/items_icons/laser_beam.webp',
    useScene: 'combat',
    price: 7,
    combatUse: 'laserEye',
    laserDamage: 5
  ...
  R.registerItem({
    ...
    icon: '../icons/buff_icons/guard.webp',
    useScene: 'combat',
    price: 5,
  ...
  R.registerItem({
    ...
    icon: '../icons/card_icons/disarm.webp',
    useScene: 'combat',
    price: 5,
  ...
  R.registerItem({
    ...
    icon: '../icons/card_icons/zero.webp',
    useScene: 'combat',
    price: 6,
  ...
  R.registerItem({
    ...
    icon: ICON + 'chameleon_pigment.webp',
    useScene: 'combat',
    price: 8,
  ...
  R.registerItem({
    ...
    icon: ICON + 'wisdom_necklace.webp',
  ...
  R.registerItem({
    ...
    icon: ICON + 'beast_core_sack.webp',
  ...
  R.registerItem({
    ...
    icon: ICON + 'discount_coupon.webp',
  ...
  R.registerItem({
    ...
    icon: '../icons/buff_icons/time_bomb.webp',
    useScene: 'combat',
    price: 5,
